        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Hello
              <span className="text-yellowCustom"> I&apos;m Khaerul ilman</span>
            </h1>
            <p className="text-lg md:text-xl opacity-90 max-w-lg">
              I&apos;m an enthusiast in backend development
            </p>
            <div className="text-lg md:text-xl opacity-90 max-w-lg">
              <p>
                Mochammad Khaerul Ilman adalah mahasiswa Teknik Informatika di
                UIN Sunan Gunung Djati Bandung, angkatan 2022. Saya telah
                tertarik dengan dunia IT sejak masih di bangku SMA. Saya senang
                mempelajari hal-hal baru, khususnya di bidang teknologi.
              </p>
            </div>
          ...
          >
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
              ...
              <div className="absolute inset-0 bg-yellowCustom rounded-full opacity-20 transform -translate-x-4 translate-y-4" />

              {/* Profile image container */}
              <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-yellowCustom">
                <img
              ...
              <div className="absolute -top-4 -right-4 w-12 h-12 bg-yellowCustom rounded-full opacity-60" />
              <div className="absolute -bottom-4 -left-4 w-8 h-8 bg-yellowCustom rounded-full opacity-60" />
            </div>
          </motion.div>
        </div>
      </div>
